...
namespace LAbBA3.Controllers
{
    public class StarsController : Controller
    {
        ...
        public StarsController(DB context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("StarId,Name,Size")] Star star)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StarId,Name,Size")] Star star)
        {
            if (id != star.StarId)
            {
                return NotFound();
